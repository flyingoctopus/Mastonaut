...
extension Acknowledgements
{
	static func load(plist: String) -> Acknowledgements?
	{
		...
		var acknowledgements = try! PropertyListDecoder().decode(Acknowledgements.self, from: cocoaPodsAcknowledgementsData)
		
		acknowledgements.entries.append(Entry(title: "PullRefreshableScrollView",
											  text: "https://github.com/deicoon/PullRefreshableScrollView"))
		
		acknowledgements.entries.append(Entry(title: "LoggingOSLog",
											  text: """
								 Apache License
